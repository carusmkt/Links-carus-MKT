...
Página estática para o link da bio do Instagram. Não requer instalação ou processo de build.

## Publicação no GitHub Pages

1. Coloque `index.html` e a pasta `assets` na raiz de um repositório da organização `carusmkt` no GitHub.
